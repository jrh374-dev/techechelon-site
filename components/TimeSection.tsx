    ...
    <section className="border-b border-rule">
      <div className="max-w-[1320px] mx-auto px-7 py-10">
        <div className="flex items-baseline gap-4 mb-7 pb-3 border-b border-rule">
          ...
          <span className="font-mono text-[11px] tracking-[0.08em] uppercase font-semibold text-sand">
            {range}
          </span>
          <span className="flex-1 border-b border-rule mb-1" />
    ...
    <article className="group">
      <Link href={`/post/${post.slug}`} className="block">
        <div className="flex items-baseline gap-2.5 mb-3">
          <span className="font-mono text-[12.5px] font-bold tracking-tight text-coral">
            №{num.toString().padStart(2, "0")}
          </span>
          <span className="font-mono text-[10px] tracking-[0.06em] uppercase font-semibold text-sand">
            {publishedClock(post.publishedAt)}
          </span>
          <span className="text-sand-light">·</span>
          <span className="font-mono text-[10px] tracking-[0.06em] uppercase font-bold text-navy">
        ...
        />
        <h3 className="font-display text-[21px] font-extrabold tracking-[-0.022em] leading-[1.1] text-ink mb-2.5 group-hover:text-navy">
          {post.title}
        </h3>
        ...
        <div className="flex justify-between items-baseline pt-2.5 border-t border-rule-soft">
          ...
          <span className="font-mono text-[10px] tracking-[0.04em] uppercase text-sand font-medium">
