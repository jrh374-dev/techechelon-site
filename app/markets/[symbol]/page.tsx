  ...
  return (
    <div className="bg-cream min-h-screen">
      ...
      <section className="border-b border-rule">
        <div className="max-w-[1320px] mx-auto px-7 pt-9 pb-8">
          <div className="font-mono text-[10.5px] tracking-[0.16em] uppercase font-bold text-coral mb-3">
            ━━ {kindLabel(sym.kind).toUpperCase()}
            {sym.sector && ` · ${sym.sector.toUpperCase()}`}
          </div>
          <div className="grid grid-cols-[1.2fr_1fr] gap-12 items-start">
            <div>
              <h1 className="font-display text-[52px] font-extrabold tracking-[-0.035em] leading-[0.96] text-navy">
                {sym.name}
              </h1>
              <div className="mt-3 font-mono text-[11px] tracking-[0.1em] uppercase font-bold text-sand">
                {sym.symbol}
              </div>
              <p className="font-serif text-[17px] leading-relaxed text-ink-soft italic mt-5 max-w-[560px]">
                {sym.description}
              </p>
            </div>
            <div className="border-l border-rule pl-10">
              <div className="font-mono text-[10.5px] tracking-[0.14em] uppercase font-bold text-sand mb-2">
                LAST PRICE
              </div>
              <div className="flex items-baseline gap-4">
                <span className="font-mono text-[42px] font-bold tracking-tight text-ink leading-none">
                  {sym.price}
                </span>
                <span className={`font-mono text-[16px] font-bold ${changeColor}`}>
      ...
      <section className="border-b border-rule bg-white">
        <div className="max-w-[1320px] mx-auto px-7 py-9">
          <div className="flex items-baseline gap-4 mb-5">
            <h2 className="font-display text-[22px] font-extrabold tracking-[-0.022em] text-navy leading-none">
              Price · last 3 months
            </h2>
        ...
        <section className="border-b border-rule">
          <div className="max-w-[1320px] mx-auto px-7 py-9">
            <div className="flex items-baseline gap-4 mb-7 pb-3 border-b border-rule">
              ...
              <span className="flex-1 border-b border-rule mb-1.5" />
              <span className="font-mono text-[10.5px] tracking-[0.06em] uppercase font-bold text-coral">
