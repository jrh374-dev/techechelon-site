---
title: "Executive Q&A: Woody Sessoms from Graphiant on Driving Innovation and Strategic IT Transformation"
slug: executive-q-a-woody-sessoms-from-graphiant-on-driving-innovation-and-strategic-it-transformation
excerpt: "Woody Sessoms is a distinguished figure in the technology and telecommunications sectors, renowned for his strategic vision and..."
category: security
...
Leveraging data is essential—it acts as a strategic enabler across all business operations. The core goal is to deliver the right information to the right people at the right time, which is vital for competitiveness in the market. Technology excels at ensuring that data is not only accessible but also reliable, consumable, and secure.
...
To support real-time decision-making, data must be universally accessible—anytime, anywhere, from any device. Moreover, today's data, often unstructured and derived from diverse sources such as sensors used in manufacturing, pharmaceuticals, and agriculture, requires new handling strategies. This brings us to another key trend: the move away from centralized data centers. Instead, we're seeing a shift towards distributed data centers located close to where data originates, enabling faster, on-the-spot decision-making.
...
In the case of our project with the South Carolina municipality, we first aimed to thoroughly understand the unique challenges the municipality faced. We spent time with both IT professionals and business stakeholders to grasp their needs and objectives. Our strategy involves developing practical and affordable solutions tailored to the specific problems our clients are trying to solve.

In the early stages of Graphiant, my colleagues and I mapped out which industries would benefit most from our initial use cases. Today, our customer base spans across various sectors such as financial services, manufacturing, entertainment, healthcare, service providers, and government.
...
Risk mitigation is another crucial aspect of our strategy. We design our solutions to minimize various operational risks, ensuring that organizations feel confident in adopting our technology. This is especially important for sectors like law enforcement, where operational readiness and security are paramount.

Our architecture and engineering approach enables rapid deployment without the need for extensive IT staff or specialized network professionals. Being cloud-based, our solutions allow for the quick setup of enterprise-class secure networks.
...
Currently, we are focusing on expanding this model to other municipalities and related sectors. We aim to establish a proven practice by refining our approach, improving market strategies, and perfecting the implementation process. This includes navigating all the necessary regulations involved with public sector engagements.

Our strategy involves consolidating our efforts around this successful use case, refining it further, and then scaling it to similar scenarios in adjacent fields. Once we have validated the approach with about three implementations, we plan to engage our partner community more broadly to accelerate adoption and impact.
...
To effectively communicate this, IT leaders should aim to quantify these outcomes in financial terms whenever possible. This can include specifics like cost savings, revenue generation, or more subjective metrics like market share expansion.

At Graphiant, for example, we've collaborated with ACG Research to develop a bespoke cost-out tool. This tool helps enterprises and service providers calculate the dollar savings from implementing our solutions. It uses a combination of fixed constants and variables input by the client, ensuring the analysis is tailored and relevant.

For IT leaders who may lack the expertise to perform these calculations, engaging with firms like ACG Research or other consultants can be beneficial. In my own experience running an IT department, I found that having the ability to quantify the economic impact of technology investments is indispensable.

For organizations where this capability is not yet developed, I recommend starting with a one-time assessment to establish a baseline, then gradually building this analytical capability into an ongoing internal practice.
...
To effectively integrate innovative technologies like AI into their operations, leaders in sales, marketing, operations, manufacturing, risk management, and other areas must consider how these technologies can enhance their specific domains. It's about understanding the potential applications of technology within their sphere of influence and recognizing the benefits these innovations can bring. This understanding should extend beyond technical specifics to focus on strategic outcomes that could transform their operations and competitive position.
...
The role of this executive sponsor is crucial; they focus on the business case for the technology solution being considered. Often, organizations will conduct a proof of concept that is technically successful but fails to move forward because it lacks a clear economic value or compelling business rationale compared to other potential investments. Our approach ensures that there's not only technical validation but also a strong business justification for each project.

This executive sponsor must have the authority to create budgets and allocate resources, enabling them to articulate the value of our solutions quickly and effectively. We emphasize that our technology solutions should contribute to making money, saving money, or protecting the company's brand through enhanced security. Each use case must demonstrate a tangible economic or brand protection benefit.
...
We have implemented a unique approach by creating a stateless core in our network devices, which means that these devices do not retain any state information about the traffic that flows through them. This design ensures that even if a device is compromised, the intruder cannot determine the traffic's origin or destination, as there are no IP addresses or routing information stored in the devices themselves. All critical data and control mechanisms like routing tables are encrypted and stored securely in the cloud.

Additionally, we utilize a patented quantum encryption scheme with symmetrical keys that significantly enhances security. This method is inherently more secure and complex to breach compared to traditional encryption techniques. Furthermore, our architecture ensures that data remains untouched and continuously encrypted as it traverses our network, eliminating potential vulnerabilities typically found at junction points or seams in the network infrastructure.
...
However, the real challenge and opportunity with AI isn't just its application but also how businesses can effectively support it. AI demands distributed processing, centers of data close to where data originates, and ultra-low latency networking. This architecture shift means that the data processing will move closer to the data's source, which often involves managing large volumes of unstructured data. This setup allows for more efficient querying and utilization of the data.

At Graphiant, we recognize that while there's considerable discussion about AI capabilities like large language models, there isn't enough focus on the critical infrastructure required to support these technologies, particularly the interactions between data sources and processing units like GPUs.
...
This streamlined architecture reduces the likelihood of downtime and outages caused by misconfigurations and simplifies change management processes, as updates are managed similarly to cloud-based systems like those used in smartphones. This approach not only makes our network more reliable and serviceable but also significantly reduces the total cost of ownership.
...
To ensure our solutions meet the demands of modern data traffic, over half of our engineering team comes from backgrounds in cloud computing and hyperscale environments. This expertise allows us to build solutions that scale to billions of interactions, far surpassing the capacity of traditional networks that typically consider scalability in terms of hundreds of thousands or millions.

Our aim is to bring the efficiencies and scalability of hyperscale technologies like those seen in companies such as Google, Facebook, and AWS to traditional networking. This involves rethinking network architecture to eliminate issues like bloated middle mile and inefficient tunneling, which are common in existing networks.
...
Here at Graphiant, we advocate for solutions that not only address immediate problems but also prepare your infrastructure for future developments. This involves considering how your current decisions will impact your business in the long run and ensuring that every IT investment can adapt to future changes and expansions.

Furthermore, every significant IT project should be accompanied by a robust business case. It's vital to understand and quantify the expected business outcomes to ensure that the technology investment will positively affect your company's trajectory. Demand clear evidence of how the technology will move the business needle, focusing on measurable results and outcomes.

Lastly, in today's rapidly changing environment, it is also essential to maintain flexibility in your strategic planning. Consider external factors and the potential need to scale up or down. This foresight will allow your business to remain agile and responsive to unforeseen changes, ensuring long-term success and relevance in your industry.
